...
const Extras = () => {
    return (
        <div className="section" id="the-extras">
            <div className="gutters">
                <div className="u-text-center u-mb-xl">
                    <h2>The extras</h2>
                </div>
                <div className="line-length-large">
                    ...
                    <h6>Dress</h6>
                    <p>
                        You can never be too over dressed! The venue will be
                        heated, but remember to bring something warm to put on
